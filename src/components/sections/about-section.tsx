            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>
                    When I'm not coding, I'm exploring new challenges, or
                    refining my skills in different tech stacks. Always open to
                    new opportunities and collaborations that push the
